package com.yummyfiles.musicx.ui.theme
...
fun getTypography(terminalMode: Boolean): Typography {
    val fontFamily = if (terminalMode) ShareTechMono else FontFamily.Default
