...
> **Learn more:** [https://keepandroidopen.org](https://keepandroidopen.org)

---

## ❯ SO... WHAT IS MUSICX?

Basically, I got tired of music apps making everything unnecessarily annoying.

You just wanna listen to your own music and suddenly there's:
* A subscription
* An ad
* A "Start Free Trial" button
* An account you never wanted
* Some random cloud service
* 500 recommendations for songs you don't care about

Like bro, I just wanted to play a song.

So I made MusicX.

It's an **offline-first Android music player** made for your local music library.

> Your music should stay yours.

Put your music on your phone, open MusicX, and just listen.
...
| Feature | Description |
| :--- | :--- |
| **OFFLINE** | Your music works without Wi-Fi or data. |
| **AD-FREE** | No ads randomly jumping in your face. |
| **LOCAL-FIRST** | Your music stays on your device. |
| **NO ACCOUNT** | You don't need an account just to listen to music. |
| **CUSTOMIZABLE** | Make the player look how you want. |
| **OPEN SOURCE** | You can actually see what the app is doing. |
...
* No "Upgrade to Premium" nonsense
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/COMPOSE-black?style=flat-square&logo=jetpackcompose" alt="Compose">
  <img src="https://img.shields.io/badge/MEDIA3-black?style=flat-square" alt="Media3">
  <img src="https://img.shields.io/badge/ROOM-black?style=flat-square" alt="Room">
  <img src="https://img.shields.io/badge/DATASTORE-black?style=flat-square" alt="DataStore">
</p>

| Technology | What it's doing |
| :--- | :--- |
| **Kotlin** | The entire app |
| **Jetpack Compose** | The UI |
| **Media3** | Actually playing the music |
| **Room** | Local database stuff |
| **DataStore** | Settings and preferences |
| **MediaStore** | Finding your music |

---

## ❯ ROADMAP

MusicX is still being worked on, so there's a bunch of stuff I wanna add/fix.

### Coming up
- [ ] Better lyrics support
- [ ] Sleep timer
- [ ] Ambient sounds
- [ ] Home screen widgets
- [ ] Bluetooth controls
...
- [ ] YouTube-to-MP3 importing

This isn't some locked-in corporate roadmap or anything. Stuff can obviously change as MusicX gets better.
...
<p align="center">
  <img src="assets/visualizer.svg" alt="Visualizer" width="600" />
</p>
...
No giant menus.  
No 700 buttons.  
No random stuff taking up half the screen.  
